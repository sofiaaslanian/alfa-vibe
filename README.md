...
На начальном этапе, до стабильного доступа к DeepSeek Flash через Kilo Code, команда использовала ChatGPT и Cursor. Ими разбирали требования, обсуждали архитектуру, готовили первые прототипы и код, отлаживали отдельные части.

Команда заранее сообщила об этом организаторам. Организаторы разрешили сдавать полученное решение и обязали указать в README объём использования сторонних инструментов. Долю в процентах или токенах команда не измеряла, поэтому цифры здесь не приводятся.

После получения рабочего доступа дальнейшую AI-доработку submission-кода команда ведёт через Kilo Code и DeepSeek Flash в контуре AlfaGen.
